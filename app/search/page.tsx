  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Global search across SupportOps Career Lab</h1>
        <p className="mt-3 text-sm leading-7 text-slate-600">
          Search modules, scenarios, career tracks, and core app routes from one place.
        </p>
